...
% Crie um axes para representar a barra de progresso
handles.progress = axes('Parent', handles.figure1, 'Units', 'normalized', 'Position', [0.1 0.1 0.8 0.05]);
box(handles.progress, 'on');
xlim(handles.progress, [0 1]);
ylim(handles.progress, [0 1]);
